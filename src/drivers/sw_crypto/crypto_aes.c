 ...
 */
int crypto_aes_setup(const unsigned char *key, int keylen, int num_rounds, crypto_aes_key *skey)
{
    int i;
    ulong32 temp, *rk;
...
int crypto_aes_encrypt(const unsigned char *pt, unsigned char *ct, crypto_aes_key *skey)
{
